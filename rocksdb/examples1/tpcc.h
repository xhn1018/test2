...
#include "macros.h"
// This file defines globals that can be set in python main
#include "config.h"

// NumWarehouses is now in config.h
...
string tbl_warehouse = "warehouse";
string tbl_item = "item";
string tbl_stock = "stock";
string tbl_stock_data = "stock_data";
string tbl_district = "district";
string tbl_customer = "customer";
string tbl_customer_name_idx = "customer_name_idx";
string tbl_history = "history";
string tbl_oorder = "oorder";
string tbl_oorder_c_id_idx = "oorder_c_id_idx";
string tbl_new_order = "new_order";
string tbl_order_line = "order_line";

// take default column family into account
static int cfd_count = 13;
